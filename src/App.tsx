...
import { CrossPortfolioNav } from "./components/CrossPortfolioNav";
...
const selectedProjects = [
  {
    ...
    tech: "n8n / Node.js",
    description:
      "End-to-end automation pipeline for multi-channel content distribution and lead filtering.",
    outcome: "Reduced operational overhead by 75%",
    details:
      "Architected complex n8n workflows utilizing custom JS nodes for data transformation and advanced error handling.",
  },
  {
    ...
    description:
      "Autonomous research agent capable of web browsing, document analysis, and synthesis.",
    outcome: "3x faster technical research cycles",
    details:
      "Implemented RAG with Pinecone and function-calling capabilities for real-time tool orchestration.",
  },
  {
    ...
    description:
      "Intelligent lead qualification engine using LLMs to score inbound prospects based on intent.",
    outcome: "40% increase in sales conversion",
    details:
      "Built a multi-stage scoring logic that integrates with HubSpot and uses OpenAI for qualitative analysis.",
  },
  {
    ...
    description:
      "Production-ready Slack bot for monitoring server health and executing remote deployments.",
    outcome: "Saved 15+ dev hours weekly",
    details:
      "Secure integration with AWS SDK for triggered actions and real-time status updates in Slack.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white font-sans overflow-x-hidden">
      ...
      <main className="relative z-10 pt-20">
        ...
        <section className="min-h-[50vh] flex items-center justify-center py-20 px-6">
          ...
          >
            ...
            <p className="text-xl text-gray-400 leading-relaxed mb-8">
              ...
              and autonomous agents. Specializing in n8n workflows, agentic
              orchestration, and scaling business logic with AI.
            </p>
              ...
              {[
                {
                  value: "60+",
                  label: "Automations",
                  desc: "Workflows deployed",
                },
                {
                  value: "100k+",
                  label: "Invocations",
                  desc: "Monthly API throughput",
                },
                ...
                >
                  <div className="text-2xl md:text-3xl font-bold text-indigo-400 mb-1 font-mono tracking-tighter">
                    {stat.value}
                  </div>
        ...
        {/* Ecosystems Section - Always visible */}
        <EcosystemsSection />
        ...
        <div className="max-w-6xl mx-auto px-6 py-16">
            ...
            >
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6 text-gray-400">
                  <p>
                    AI Automation Engineer specializing in{" "}
                  ...
                  <p>
                    ...
                    at <strong>Wipro</strong>, leveraging my expertise to
                    architect mission-critical automation pipelines and
                    AI-driven internal tools that optimize operational
                    efficiency at scale.
                  </p>
                </div>
                <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                  <h3 className="font-semibold mb-4 text-sm uppercase tracking-wider text-indigo-400 font-mono">
                    Quick Info
                  </h3>
          ...
          {activeTab === "work" && (
            ...
            >
              ...
              <p className="text-gray-400 text-lg">
                A showcase of complex workflows and AI-driven engines.
              </p>
          ...
          {activeTab === "skills" && (
            ...
            >
              ...
              <p className="text-gray-400 text-lg">
                Core competencies across AI, development, and product.
              </p>
                    ...
                    <div className="space-y-6">
                      <div className="pl-6 border-l-2 border-indigo-500/50">
                        ...
                        <p className="text-gray-400 leading-relaxed text-sm">
                          Spearheading automation initiatives using n8n and
                          advanced Python workflows. Focused on architecting
                          intelligent agents that leverage LLMs for
                          high-reliability internal systems and service
                          optimization. Deployed 60+ production-grade
                          automations resulting in significant OpEx reduction
                  ...
                  <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                    ...
                    <div className="pl-6 border-l-2 border-gray-700">
                      ...
                      <p className="text-gray-500 text-sm">
                        Focus on Algorithms, AI, and System Design.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                    ...
                    <div className="space-y-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {["n8n", "Zapier", "Make", "Python", "Node.js"].map(
                            (tech) => (
                              <span
                                key={tech}
                                className="px-3 py-1 bg-indigo-500/10 text-indigo-300 rounded text-sm"
                              >
                                {tech}
                              </span>
                            ),
                      ...
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                          {["LangChain", "OpenAI", "Claude", "Vector DBs"].map(
                            (tech) => (
                              <span
                                key={tech}
                                className="px-3 py-1 bg-indigo-500/10 text-indigo-300 rounded text-sm"
                  ...
                  <div className="p-6 bg-white/5 border border-white/10 rounded-2xl">
                    ...
                    <div className="space-y-3">
                      ...
                      >
                        ...
                        <span className="text-sm font-mono tracking-tight text-white/80">
          ...
          {activeTab === "resume" && (
            ...
            >
              ...
              <p className="text-gray-400 text-lg">
                First 3–6 months as your AI Automation Engineer
              </p>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="p-6 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-white/10 rounded-2xl">
                  ...
                  <p className="text-gray-400 leading-relaxed text-sm">
                    Map your current manual processes and identify automation
                    opportunities. Calculate ROI for each workflow and
                ...
                <div className="p-6 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-white/10 rounded-2xl">
                  ...
                  <p className="text-gray-400 leading-relaxed text-sm">
                    ...
                    Implement error handling, retry logic, and monitoring for
                    reliability.
                  </p>
                </div>
                ...
                <div className="p-6 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-white/10 rounded-2xl">
                  ...
                  <p className="text-gray-400 leading-relaxed text-sm">
                    ...
                    Use RAG for domain knowledge and function calling for tool
                    use.
                  </p>
                </div>
                ...
                <div className="p-6 bg-gradient-to-br from-indigo-500/10 to-purple-500/10 border border-white/10 rounded-2xl">
                  ...
                  <p className="text-gray-400 leading-relaxed text-sm">
                    ...
                    Build dashboards that show the business impact of
                    automation.
                  </p>
                </div>
              </div>
          ...
          {activeTab === "contact" && (
            ...
            >
              ...
              <p className="text-gray-400 text-lg max-w-2xl">
                Let's automate the future. Reach out if you need an AI
                Automation Engineer to architect intelligent pipelines and
                agentic systems.
              </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-4 gap-12 mb-16">
            <div className="col-span-1 md:col-span-2">
              <h4 className="text-xl font-bold mb-4 tracking-tighter">
                KAZI MUSHARRAF
              </h4>
              <p className="text-sm text-gray-500 max-w-sm leading-relaxed">
                AI Automation Engineer dedicated to building mission-critical
                pipelines and autonomous agentic systems. Scalability and
                reliability driven.
              </p>
            </div>
            <div>
              <h4 className="text-xs font-mono font-bold uppercase tracking-[0.2em] text-indigo-400 mb-6">
                Expertise
              </h4>
